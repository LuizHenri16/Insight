    ...
    return (
        <div className="w-full max-w-5xl max-h-[32rem] overflow-y-auto mx-auto p-2 sm:p-6">
            <form className="flex flex-col gap-10" onSubmit={handleSubmit}>
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="flex flex-col gap-2">
                            <label htmlFor="nome_empresa" className="text-sm font-medium text-gray-700">Nome da empresa</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="cnpj_empresa" className="text-sm font-medium text-gray-700">CNPJ</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="conta" className="text-sm font-medium text-gray-700">Conta</label>
                ...
                <section className="space-y-6">
                    <div className="border-b pb-3">
                        <h2 className="text-xl font-semibold text-gray-800">Dados dos Sócios</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-5 rounded-xl bg-gray-50/50 border border-gray-100 space-y-4">
                            ...
                            <div className="space-y-4">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="socio1_nome" className="text-sm font-medium text-gray-700">Nome completo</label>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="socio1_cpf" className="text-sm font-medium text-gray-700">CPF ou CNPJ</label>
                        ...
                        <div className="p-5 rounded-xl bg-gray-50/50 border border-gray-100 space-y-4">
                            ...
                            <div className="space-y-4">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="socio2_nome" className="text-sm font-medium text-gray-700">Nome completo</label>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="socio2_cpf" className="text-sm font-medium text-gray-700">CPF ou CNPJ</label>
                ...
                <section className="space-y-6">
                    <div className="border-b pb-3">
                        <h2 className="text-xl font-semibold text-gray-800">Dados de Contato</h2>
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium text-gray-700">Produtos/Serviços</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium text-gray-700">Rating de Crédito</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium text-gray-700">Cheque especial</label>
